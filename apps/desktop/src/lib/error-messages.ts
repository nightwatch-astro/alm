...
export const ERROR_MESSAGES: Record<ErrorCode, () => string> = {
  ...
  'project.update_view_plan_not_found': m.err_project_update_view_plan_not_found,
  'project.update_view_plan_not_open': m.err_project_update_view_plan_not_open,
  'project.update_view_plan_not_approved': m.err_project_update_view_plan_not_approved,
  ...
  'project.update_view_source_unavailable': m.err_project_update_view_source_unavailable,
  'project.update_view_root_changed': m.err_project_update_view_root_changed,
  'project.update_view_plan_digest_mismatch': m.err_project_update_view_plan_digest_mismatch,
  'project.update_view_session_too_large': m.err_project_update_view_session_too_large,
